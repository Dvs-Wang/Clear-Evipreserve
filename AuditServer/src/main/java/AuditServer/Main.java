...
import static AuditServer.utils.GuiUtils.*;

public class Main extends Application {
    public static NetworkParameters params = TestNet3Params.get();
    public static final String APP_NAME = "AuditServer";
    ...
    public void stop() throws Exception {
        if(controller.getInstitution() != null){
            controller.getInstitution().save();
        }
        bitcoin.stopAsync();
